...
export const HIDDEN_CIPHER_DEFINITIONS = [
    {
        id: "hashbrowns_and_salt",
        name: "Source Code Archaeologist",
        desc: "Excavated and inspected the underlying cryptographic cartridge source.",
        hint: "Undiscovered secret system anomaly.",
        icon: "[??]",
        hidden: true
    },
    {
        id: "sam_and_dean",
        name: "You're a Winchester now",
        desc: "Heard the last words of a legendary Hunter.",
        hint: "Undiscovered secret system anomaly.",
        icon: "[??]",
        hidden: true
    },
    {
        id: "identity_theft_is_not_a_joke",
        name: "Famous Impostors",
        desc: "Did you really think it would be that easy? Better luck next time! Ciao~",
        hint: "Undiscovered secret system anomaly.",
        icon: "[??]",
        hidden: true
    }
...
export function getAllCipherDefinitions() {
    return [...CIPHER_DEFINITIONS, ...HIDDEN_CIPHER_DEFINITIONS];
}
